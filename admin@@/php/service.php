...
function service_cate($db)
{
    ...
    $head_title=array('Tiêu đề<code>Vi/En</code>','Icon','Thứ tự','Hiển thị');
	...
	<div class="row">
        ...
        <div class="col-lg-12">
            '.$form->text('icon',array('label'=>'Icon (search-barcode, hosting, mouse, social-network, search-web, global)','required'=>true)).'
...
function service($db)
{
	...
	<div class="row">
        ...
        <div class="col-lg-12">
            '.$form->file('file',array('label'=>'Hình ảnh<code>310,220</code>')).'
