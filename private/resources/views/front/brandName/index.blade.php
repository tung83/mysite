...
@endsection
@section('main')
    @include('front.service.partials.service-categories', compact('serviceMenu','currentServiceCategory','serviceCategories'))
...
<script>    
    ...
    $(document).on('click','.services-page .slick-slider a', function(e){
        e.preventDefault();                
        $('.services-page .slick-slider a').removeClass('active');
