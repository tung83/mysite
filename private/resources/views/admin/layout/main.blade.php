...
<html lang="{{ config('app.locale') }}">
    <head>
        ...
        <title>{{ trans('front/site.title') }} | Admin</title>
...
<div class="wrapper">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-right">
                    <a id="logout" href="{{route('logout')}}" class="btn btn-default btn-flat"><i class="fa fa-sign-out"></i><span>Sign out</span></a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      <!-- Sidebar user panel -->
      @include ('admin.partial.user-sidebar')
